...
<html>
  ...
  <body bgColor='#ffffff' style="margin: 0;padding: 0">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" background="<%=path %>/images/login_06.gif">
	  <tr>
	    <td width='30%' height="60" style="font-size:26px; font-weight: bold;">&nbsp;&nbsp;视频分享网</td>
	    	...
	    	<table width="750" border="0" cellspacing="0" cellpadding="0">
		      <tr>
			      <td align="right" height="26" style="padding-right:10px;line-height:26px;font-size:17px">
						...
						[<a href="javascript:ChangeMenu(0);">隐藏目录</a>]
			      </td>
	          </tr>
	        </table>
	    </td>
