...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           function userDongjie(userId)
           {
               if(confirm('您确定冻结该用户吗？'))
               {
                   window.location.href="<%=path %>/userDongjie.action?userId="+userId;
               }
           }
           function userJiedong(userId)
           {
               if(confirm('您确定解冻该用户吗？'))
               {
                   window.location.href="<%=path %>/userJiedong.action?userId="+userId;
               }
           }
       </script>
	</head>
			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
					    ...
					    <s:if test="#user.userType==0">
					        <a href="#" onclick="userDongjie(<s:property value="#user.userId"/>)" class="pn-loperator">冻结</a>
					     </s:if>
					     <s:if test="#user.userType==1">
					        <a href="#" onclick="userJiedong(<s:property value="#user.userId"/>)" class="pn-loperator">解冻</a>
					     </s:if>
					</td>
				</tr>
				</s:iterator>
