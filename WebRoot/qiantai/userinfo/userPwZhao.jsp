										...
										<form action="<%=path %>/userPwZhao.action" name="form1" method="post">
										    <table align="left" border="0">
										        ...
										        <tr>
										             ...
										             <td>
										                 <input type="text" name="userOne1" id="userOne1"/>
										             </td>
										        </tr>
										        <tr>
										             <td align="center">答案:</td>
										             <td>
										                 <input type="text" name="userOne2" id="userOne2"/>
										             </td>
										        </tr>
										        <tr>
										             <td colspan="2">
